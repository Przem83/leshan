    ...
    public void server_handle_multiple_timestamped_node() throws InterruptedException, TimeoutException {
        ...
        serverBuilder.setDecoder(new LwM2mDecoder() {
            ...
            public Map<LwM2mPath, LwM2mNode> decodeNodes(byte[] content, ContentFormat format, List<LwM2mPath> paths,
                ...
                TimestampedLwM2mNodeList timestampedLwM2mNodeList = new TimestampedLwM2mNodeList(timestampedNodes);

                result.put(new LwM2mPath("/2000/2/3"), timestampedLwM2mNodeList);
                return result;
            }
        ...
        assertTrue(lwM2mNode instanceof TimestampedLwM2mNodeList);
        TimestampedLwM2mNodeList timestampedNodes = (TimestampedLwM2mNodeList) lwM2mNode;
        assertEquals(timestampedNodes.getId(), 3);
        assertEquals(timestampedNodes.getTimestampedNodes(), getExampleTimestampedNodes());
    }
