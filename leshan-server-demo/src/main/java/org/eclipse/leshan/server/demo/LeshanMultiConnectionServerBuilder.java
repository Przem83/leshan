 ...
 * {@link LeshanMultiConnectionServerBuilder} ready to operate.
 */
public class LeshanMultiConnectionServerBuilder {

    private static final Logger LOG = LoggerFactory.getLogger(LeshanMultiConnectionServerBuilder.class);
     ...
     */
    public LeshanMultiConnectionServerBuilder setLocalAddress(String hostname, int port) {
        if (hostname == null) {
     ...
     * By default a wildcard address and the default CoAP port(5683) is used.
     */
    public LeshanMultiConnectionServerBuilder setLocalAddress(InetSocketAddress localAddress) {
     ...
     *        ephemeral port in a bind operation.
     */
    public LeshanMultiConnectionServerBuilder setLocalSecureAddress(String hostname, int port) {
        if (hostname == null) {
     ...
     */
    public LeshanMultiConnectionServerBuilder setLocalSecureAddress(InetSocketAddress localSecureAddress) {
     ...
     * 
     */
    public LeshanMultiConnectionServerBuilder setRegistrationStore(CaliforniumRegistrationStore registrationStore) {
     ...
     * 
     */
    public LeshanMultiConnectionServerBuilder setSecurityStore(SecurityStore securityStore) {
     ...
     * connection.
     */
    public LeshanMultiConnectionServerBuilder setAuthorizer(Authorizer authorizer) {
     ...
     * 
     */
    public LeshanMultiConnectionServerBuilder setObjectModelProvider(LwM2mModelProvider objectModelProvider) {
     ...
     * {@link LeshanMultiConnectionServerBuilder#setCertificateChain(X509Certificate[])} should be used.
     */
    public LeshanMultiConnectionServerBuilder setPublicKey(PublicKey publicKey) {
     ...
     */
    public LeshanMultiConnectionServerBuilder setPrivateKey(PrivateKey privateKey) {
     ...
     * RPK support, use {@link LeshanMultiConnectionServerBuilder#setPublicKey(PublicKey)} instead.
     */
    public <T extends X509Certificate> LeshanMultiConnectionServerBuilder setCertificateChain(T[] certificateChain) {
     ...
     */
    public <T extends Certificate> LeshanMultiConnectionServerBuilder setTrustedCertificates(T[] trustedCertificates) {
     ...
     */
    public LeshanMultiConnectionServerBuilder setCoapConfig(NetworkConfig config) {
     ...
     */
    public LeshanMultiConnectionServerBuilder setDtlsConfig(Builder config) {
     ...
     */
    public LeshanMultiConnectionServerBuilder disableUnsecuredEndpoint() {
     ...
     */
    public LeshanMultiConnectionServerBuilder disableSecuredEndpoint() {
     ...
     * with queue mode.
     */
    public LeshanMultiConnectionServerBuilder disableQueueModeSupport() {
     ...
     */
    public LeshanMultiConnectionServerBuilder setClientAwakeTimeProvider(ClientAwakeTimeProvider awakeTimeProvider) {
     ...
     */
    public LeshanMultiConnectionServerBuilder setUpdateRegistrationOnNotification(boolean updateRegistrationOnNotification) {
     ...
     */
    public LeshanMultiConnectionServer build() {
