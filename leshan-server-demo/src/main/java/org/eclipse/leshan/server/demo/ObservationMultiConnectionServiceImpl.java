 ...
 */
public class ObservationMultiConnectionServiceImpl implements ObservationService, NotificationListener {

    private final Logger LOG = LoggerFactory.getLogger(ObservationMultiConnectionServiceImpl.class);
    ...
    /**
     * Creates an instance of {@link ObservationMultiConnectionServiceImpl}
     *
     ...
     */
    public ObservationMultiConnectionServiceImpl(CaliforniumRegistrationStore store, LwM2mModelProvider modelProvider,
