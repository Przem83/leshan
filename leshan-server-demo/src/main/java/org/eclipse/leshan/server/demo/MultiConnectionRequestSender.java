...
import org.eclipse.leshan.core.californium.*;
 ...
 */
public class MultiConnectionRequestSender implements Destroyable {

    static final Logger LOG = LoggerFactory.getLogger(MultiConnectionRequestSender.class);
