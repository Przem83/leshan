 ...
 * </p>
 */
public class LwM2mObjectImpl implements LwM2mObject {

    private int id;

    private final Map<Integer, LwM2mObjectInstance> instances;

    public LwM2mObjectImpl(int id, Collection<LwM2mObjectInstance> instances) {
    ...
    public LwM2mObjectImpl(int id, LwM2mObjectInstance... instances) {
    ...
    public boolean equals(Object obj) {
        ...
        LwM2mObjectImpl other = (LwM2mObjectImpl) obj;
        if (id != other.id) {
            return false;
        }
        if (instances == null) {
