 ...
 */
public class LwM2mMultipleResourceImpl implements LwM2mMultipleResource {
    ...
    public LwM2mMultipleResourceImpl(int id, Type type, Collection<LwM2mResourceInstance> instances) {
    ...
    public LwM2mMultipleResourceImpl(int id, Type type, LwM2mResourceInstance... instances) {
        this(id, type, Arrays.asList(instances));
    }

    protected LwM2mMultipleResourceImpl(int id, Map<Integer, ?> values, Type type) {
    ...
    public static LwM2mMultipleResource newResource(int id, Map<Integer, ?> values, Type type) {
        ...
        return new LwM2mMultipleResourceImpl(id, values, type);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        LwM2mMultipleResourceImpl other = (LwM2mMultipleResourceImpl) obj;
        if (id != other.id)
            return false;
        if (type != other.type)
            return false;
